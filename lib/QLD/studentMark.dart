...
class StudentMarkInfo extends StatefulWidget {
  ...
  @override
  _StudentMarkInfoWidgetState createState() => _StudentMarkInfoWidgetState();
}
class _StudentMarkInfoWidgetState extends State<StudentMarkInfo> {
  ...
  void initState() {
    ...
    examScoresData = Subcategoriess.map<Map<String, dynamic>>((element) => element as Map<String, dynamic>).toList();
    _selectedValue = widget.rank;
    print(examScoresData);
  }
  Future<void> updateStudent(String note, String id, String fullName, String classes, String rank) async {
    final response = await http.put(
      Uri.parse("https://traning.izisoft.io/v1/student-evaluations/$id"),
      headers: {
                        ...
                        children: [
                          Container(
                            ...
                            child: TextButton(
                              ...
                              onPressed: () {
                                updateStudent(noteController.text,widget.id,fullNameController.text,classNameController.text,_selectedValue);
